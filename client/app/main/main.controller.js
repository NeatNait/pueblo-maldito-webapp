...
(function(){
  ...
  /* recommended */
  angular
    .module('puebloMalditoWebappApp')
    .config(TrialConfig);

  TrialConfig.$inject = ['$provide'];

  function TrialConfig($provide) {
    $provide.decorator('Trial', trialDecorator);
  }

  trialDecorator.$inject = ['$delegate'];

  function trialDecorator($delegate) {
    ...
    return function(exception, cause) {
      ...
      alert(exception.msg);
      alert(errorData.exception);
      //$('body').html(errorData.exception);
    };
  }
})();
